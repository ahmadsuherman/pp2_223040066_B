...
public class HelloRadioButton extends JFrame {
	...
	public HelloRadioButton() {
		...
		final JRadioButton radioButton1 = new JRadioButton("Silver");
		radioButton1.setBounds(15,115,350,30);
		
		final JRadioButton radioButton2 = new JRadioButton("Gold");
		radioButton2.setBounds(15,145,350,30);
		
		final JRadioButton radioButton3 = new JRadioButton("Platinum");
